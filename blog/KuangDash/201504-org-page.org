...
<a href="https://github.com/emacs-china/emacs-china.github.io/edit/master/blog/KuangDash/201504-org-page.org">点我修改</a><br/>
以上功能仅限 emacs-china 成员使用，需要登录 github 账号。
</p>
#+END_EXPORT
...
[fn:4] 这里是悬停卡片的内容哦~~~(该功能是 emacs_love 主题包提供的……)
